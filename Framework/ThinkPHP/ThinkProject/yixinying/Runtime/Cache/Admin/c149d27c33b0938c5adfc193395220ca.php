  ...
  <![endif]-->
    <style>
        ...
        .box {
            ...
            background-image:url("/yxy/Public/admin/img/bg-login.png");
...
<div class="box">
    <br/>
    <h1 class="text-center text-white"><span class="glyphicon glyphicon-leaf"></span>&nbsp;&nbsp;房产后台管理系统</h1>
    <div class="login-box">
                ...
                <form action="<?php echo U('User/login');?>" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-xs-6 link">
                            <p class="text-center remove-margin"><small>忘记密码？</small> <a href="<?php echo U('User/find');?>" ><small>找回</small></a>
                            </p>
                        </div>
                        <div class="col-xs-6 link">
                            <p class="text-center remove-margin"><small>还没注册?</small> <a href="<?php echo U('User/register');?>" ><small>注册</small></a>
                            </p>
                        </div>
                    </div>
                </form>
...
$(document).ready(function(e) {
	...
	$("#password").blur(function(e) {
		...
		if (pwd == '') {
			...
			$("#spanpwd").html("密码不能少于6位");
			$("#spanpwd").html({"color":"#F00"});
		} else if (pwd.length > 15) {
			$("#spanpwd").html("密码不能大于15位");
			$("#spanpwd").css({"color":"#f00"});
		}　else {
			$("#spanpwd").hide();
		}
