...
<link href="/yxy/Public/css/ReleaseSale.css" rel="stylesheet" type="text/css" />
...
<div class="container-fluid">
				...
				<div class="navbar-inner">
						<div class="nav-collapse collapse navbar-responsive-collapse" id="Navigation">
							<ul class="nav">
								...
								<li>
									<a href="../Property/Property.html">楼盘</a>
								</li>
								<li>
									<a href="../Property/renting">租房</a>
								</li>
								<li>
									<a href="../Property/secondhandhouse">二手房</a>
								</li>
								<li>
									<a href="../Property/buy">买房</a>
								</li>
								<li>
									<a href="../Property/sellers">卖房</a>
								</li>
								<li><a href="<?php echo U('Index/search');?>">搜索</a></li>
							</ul>
	...
	<div class="span12">	
		...
		<div id="Right" class="span8">
			<div class="releaseSale-title">
				<h4>发布出售</h4>
			</div>
			
			<!--发布出售开始-->
			<div class="span6" id="releaseSale">
				<form action="<?php echo U('UserInfo/releasesale');?>" method="post">
					...
					<tr height="40">
						<td height="24" align="center"><label class="control-label" for="inputInfo"><span class="Required">*</span>出售类型：</label></td>
						<td><select name="state" id="">
							<option value="整套出售">整套出售</option>
							<option value="整套出售">单间出售</option>
						</select></td>
					...
					<tr height="40">
						<td></td>
						<td>
							 <button class="btn btn-info" type="submit">发布出售</button>
						</td>
						<td></td>
					</tr>
