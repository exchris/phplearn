...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="<?php echo U('Teacher/addMsg');?>">  
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea name="content" class="input" style="height:300px; border:1px solid #ddd;" data-validate="required:请输入留言内容"></textarea>
          <div class="tips"></div>
        </div>
      </div>
