...
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top">
    <h1><img src="/hc/Public/images/y.jpg" class="radius-circle rotate-hover" height="50" alt="" />学生模块</h1>
  </div>
...
<div class="leftnav">
  ...
  <ul style="display:block">
  	<li><a href="<?php echo U('Index/info');?>" target="right"><span class="icon-caret-right"></span>个人信息设置</a></li>
	<li><a href="<?php echo U('Index/pass');?>" target="right"><span class="icon-caret-right"></span>修改密码</a></li>
    <li><a href="<?php echo U('Index/score');?>" target="right"><span class="icon-caret-right"></span>成绩查询</a></li>
  </ul>   
  <h2><span class="icon-pencil-square-o"></span>留言管理</h2>
  <ul>
  	<li><a href="<?php echo U('Index/msglist');?>" target="right"><span class="icon-caret-right"></span>查看留言</a></li>
  	<li><a href="<?php echo U('Index/add');?>" target="right"><span class="icon-caret-right"></span>提交留言</a></li>
  </ul> 
</div>
