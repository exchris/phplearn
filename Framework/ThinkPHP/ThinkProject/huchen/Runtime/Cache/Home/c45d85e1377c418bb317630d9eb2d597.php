    ...
    <table class="table table-hover text-center">
      ...
      <?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          ...
          <div class="button-group">
          	<a href="<?php echo U('Admin/addTeacher');?>" class="button border-red"">
          		<span class="icon-tint">添加</span>
          	</a>
          	</div>
          	<div class="button-group">
          	<a href="<?php echo U('Admin/editTeacher?id='.$vo['tno']);?>" class="button border-red"">
          		<span class="icon-edit">修改</span>
          	</a>
          	</div>
         	<div class="button-group"> 
         	<a class="button border-red" href="<?php echo U('Admin/delTeacher?id='.$vo['tno']);?>">
